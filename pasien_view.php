...
<body>
    ...
    <div id="content">
        <h3>Data Pasien</h3>
        <hr>
        <a class="btn btn-primary mb-2" href="pasien_tambah.php">Tambah Data</a>
        <div class="card">
            <div class="card-body">
                <table class="table">
                    <thead>
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            <td class='text-center'>
                                <a href='pasien_edit.php?id_pasien=$row[id_pasien]' class='btn btn-sm btn-success'>Edit</a>
                                <a href='pasien_hapus.php?id_pasien=$row[id_pasien]' class='btn btn-sm btn-danger'>Hapus</a>
                            </td>
                            </tr>";
                            $no++;
                        }
