...
$sql_pasien = "SELECT * FROM tb_pasien WHERE id_pasien='$id_pasien'";
...
<body>
        ...
        <div class="card">
            <div class="card-body">
                <form action="" method="POST">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-select" name="jenis_kelamin" id="jenis_kelamin"
                                value='<?php echo $row['jenis_kelamin'];?>' aria-label="Default select example">
                    ...
                    <input type="submit" name="submit" class="btn btn-primary mx-auto d-block" value="Update"></input>
                </form>
            </div>
        </div>
    </div>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql_pasien = "UPDATE tb_pasien SET id_pasien = '$id_pasien', nama_pasien = '$nama_pasien', jenis_kelamin = '$jenis_kelamin', alamat = '$alamat', no_telp = '$no_telp' WHERE id_pasien = '$id_pasien'";

        if ($koneksi->query($sql_pasien) === TRUE) {
            echo "<script>
