...
<body>
            ...
            <div class="card-body">
                <form action="" method="POST">
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="id_poli"
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql_poli = "UPDATE tb_poliklinik SET id_poli = '$id_poli', nama_poli = '$nama_poli', gedung = '$gedung' WHERE id_poli = '$id_poli'";

        if ($koneksi->query($sql_poli) === TRUE) {
            echo "<script>
