...
<body>
        ...
        <div class="card">
            <div class="card-body">
                <form action="" method="POST">
                    <div class="mb-3 row">
                        <label for="id_pasier" class="col-sm-2 col-form-label">ID Pasien</label>
                        <div class="col-sm-10">
    ...
    if (isset($_POST['submit'])){
        ...
        $sql_pasien = "INSERT INTO tb_pasien (id_pasien, nama_pasien, jenis_kelamin, alamat, no_telp) VALUES ('$id_pasien','$nama_pasien','$jenis_kelamin','$alamat','$no_telp')";
